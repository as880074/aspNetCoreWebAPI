...
namespace ContosoWebAPI.Migrations
{
    ...
    [Migration("20191209131511_DataModefiled")]
    partial class DataModefiled
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContosoWebAPI.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("ContosoWebAPI.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContosoWebAPI.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("ContosoWebAPI.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("ContosoWebAPI.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContosoWebAPI.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("ContosoWebAPI.Models.Course", b =>
                {
                    b.HasOne("ContosoWebAPI.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("ContosoWebAPI.Models.CourseInstructor", b =>
                {
                    b.HasOne("ContosoWebAPI.Models.Course", "Course")
                    ...
                    b.HasOne("ContosoWebAPI.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("ContosoWebAPI.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("ContosoWebAPI.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("ContosoWebAPI.Models.OfficeAssignment", b =>
                {
                    b.HasOne("ContosoWebAPI.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("ContosoWebAPI.Models.OfficeAssignment", "InstructorId")
